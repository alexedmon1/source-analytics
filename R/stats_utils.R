...
# ============================================================================
# Equivalence (TOST) primitives — used by the `hypothesis` layer (R/hypothesis.R)
# ----------------------------------------------------------------------------
# The auto-gating engine (apply_hypothesis_gating / build_rescue_verdicts) was
# RETIRED — see DESIGN_SPEC.md. These two primitives remain: tost_equivalent() is
# called by the emmeans adapter for `kind: equivalence` hypotheses, and
# .equivalence_margin() resolves a margin spec ({mode: sd|gap_fraction, value}).
# ============================================================================
