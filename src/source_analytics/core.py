...
ANALYSIS_METADATA: dict[str, dict[str, str]] = {
    ...
    "fcd_comparison":       {"category": "resting", "level": "electrode",  "domain": "Sensor-level",    "supplements": "electrode_connectivity", "description": "Source vs sensor FCD comparison (mean + spatial CV)",
